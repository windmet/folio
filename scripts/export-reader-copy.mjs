...
const uiCopy = isSingleTrackBroadcast ? komachoeUiCopy : komatsuUiCopy;
...
const markdown = [
  ...
  ...(isSingleTrackBroadcast ? [
    ...
    `- Overview and Mentions copy are exported from \`project.json\`; the timeline contains the published ${events.size}-event narrative layer. Event evidence, qualifications, transcripts and raw source notes remain excluded.`,
  ] : []),
  '',
];
let currentScope = '';
