...
| Expandable text | **RC12-B2 + F2 已完成源码与 Browser QA**：Target / Context 原机制保留；220px Source title 与 240px Act 02 已真实验证展开／收起、ARIA、clamp 与 overflow；Timeline current title 因压力样本播放器列宽为 `0` 未触发点击分支，仍保留 `TODO consumer-check`。证据见 `docs/qa/komatsu36-rc12/b2/README.md` 与 F2 handoff |
