...
本文保留 F2 截止点的历史状态；RC12-E 随后已完成 E1–E5，之后又完成 T1 与 Y1 的独立工程／Browser 批次。当前证据改见 `docs/qa/komatsu36-rc12/e/E5-HANDOFF.md`、`docs/qa/komatsu36-rc12/t1/README.md` 与 `docs/qa/komatsu36-rc12/y1/README.md`。本表中的 E `DEFERRED / NOT IMPLEMENTED` 不回写为当前状态；T1/Y1 产品停点与 Y2 授权仍以 RC12 总 runbook 为准。
